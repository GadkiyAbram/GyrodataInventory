...
namespace Insert_Data {
    ...
    public partial class EquDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/EquDataSet12.xsd";
        ...
        public partial class EmpDataTable : global::System.Data.TypedTableBase<EmpRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmpRow AddEmpRow(string Item, string Asset, string Arrived, string Invoice, string CCD, string Status, string Box, string Container, string Comment) {
...
namespace Insert_Data.EquDataSet1TableAdapters {
    ...
    public partial class EmpTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Emp] ([Item], [Asset], [Arrived], [Invoice], [CCD], [Status], " +
                "[Box], [Container], [Comment]) VALUES (@Item, @Asset, @Arrived, @Invoice, @CCD, " +
                "@Status, @Box, @Container, @Comment)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Item, Asset, Arrived, Invoice, CCD, Status, Box, Container, Comment FROM d" +
                "bo.Emp";
        ...
        public virtual int Fill(EquDataSet1.EmpDataTable dataTable) {
        ...
        public virtual EquDataSet1.EmpDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EquDataSet1.EmpDataTable dataTable = new EquDataSet1.EmpDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EquDataSet1.EmpDataTable dataTable) {
        ...
        public virtual int Insert(string Item, string Asset, string Arrived, string Invoice, string CCD, string Status, string Box, string Container, string Comment) {
            if ((Item == null)) {
            ...
            if ((Box == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[6].Value = ((string)(Box));
            }
            if ((Container == null)) {
                throw new global::System.ArgumentNullException("Container");
            }
            else {
                this.Adapter.InsertCommand.Parameters[7].Value = ((string)(Container));
            }
            if ((Comment == null)) {
